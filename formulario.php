...
<head>
    ...
    <link rel="stylesheet" href="assets/css/Rockwell.css">
    ...
    <div class="container" style="margin-right: auto;margin-left: auto;max-width: 600px;padding-top: 30px;padding-bottom: 30px;">
        ...
        <form action="formulario.php" method="post">
            ...
            <div class="form-row">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group text"><label id="monto" for="fecha">Monto total del ticket:</label><input class="form-control" type="number" id="monto" required="" name="amount"></div>
                </div>
            </div>
            <div class="form-row">
                <div class="col">
                    ...
                    <div class="form-actions" style="background-color: transparent;text-align: center;margin-top: 30px;"><button class="btn btn-primary btn-custom text-rockwell" type="submit">JUGAR</button></div>
                </div>
            </div>
        </form>
    </div>
